...
/*   Updated: 2021/07/22 16:41:03 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		builtin_export(int index, t_cmd *cmd, char **env_list);
void		builtin_unset(int index, t_cmd *cmd, char **env_list);
void		builtin_env(int index, t_cmd *cmd, char **env_list);
void		builtin_exit(int index, t_cmd *cmd);
